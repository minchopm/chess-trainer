...
ours for anything to be sent to.

## What stays on your device

Your ratings, solved puzzles, review schedule, streaks, game history and
purchase state are stored in the app's own container on your device. Deleting
...
The app collects no data at all, so there is nothing to collect from a child
either. It shows no adverts and links out only to the source repository and to
the licence text.
